...
mongoose     // mongoDB ga ulab beradigon package
  .connect(process.env.MONGO_URL as string, {})      // .env faylga yozilgan MongoDB manzilini olib beryabti
    ...
    server.listen(PORT, function () {    // listen()- serverni ishga tushiradi. Ya’ni u berilgan portni eshitishni boshlaydi va shu portga keladigan so‘rovlarni qabul qiladi.
